/*
	...
	[
		"aiprison",	//This is the marker name to be used as the patrol and spawning area.
...
//Ai Skalisty Island
	...
	["Skalisty1",3,3,false] call DZAI_spawn_units;
    ["Skalisty2",2,2,false] call DZAI_spawn_units;	
    ["Skalisty3",3,3,false] call DZAI_spawn_units;	
    ["Skalisty4",2,2,false] call DZAI_spawn_units;	
    ["Skalisty5",3,3,false] call DZAI_spawn_units;	
    ["Skalisty6",2,2,false] call DZAI_spawn_units;	
    ["Skalisty7",3,3,false] call DZAI_spawn_units;	
    ["Skalisty8",2,2,false] call DZAI_spawn_units;	
    ["Skalisty9",3,3,false] call DZAI_spawn_units;
	["Skalisty10",2,3,false] call DZAI_spawn_units;
	["Skalisty11",3,3,false] call DZAI_spawn_units;
    ["Skalisty12",2,2,false] call DZAI_spawn_units;	
    ["Skalisty13",3,3,false] call DZAI_spawn_units;	
    ["Skalisty14",2,2,false] call DZAI_spawn_units;	
    ["Skalisty15",3,3,false] call DZAI_spawn_units;	
    ["Skalisty16",2,2,false] call DZAI_spawn_units;	
    ["Skalisty17",3,3,false] call DZAI_spawn_units;	
    ["Skalisty18",2,2,false] call DZAI_spawn_units;	
    ["Skalisty19",3,3,false] call DZAI_spawn_units;
    ["Skalisty20",2,2,false] call DZAI_spawn_units;	
    ["Skalisty21",3,3,false] call DZAI_spawn_units;	
    ["Skalisty22",2,2,false] call DZAI_spawn_units;
    ["Skalisty23",3,3,false] call DZAI_spawn_units;	
    ["Skalisty24",2,2,false] call DZAI_spawn_units;	
    ["Skalisty25",3,3,false] call DZAI_spawn_units;	
    ["Skalisty26",2,2,false] call DZAI_spawn_units;	
    ["Skalisty27",3,3,false] call DZAI_spawn_units;	
    ["Skalisty28",2,2,false] call DZAI_spawn_units;	
    ["Skalisty29",3,3,false] call DZAI_spawn_units;	
    ["Skalisty30",2,2,false] call DZAI_spawn_units;	
    ["Skalisty31",3,3,false] call DZAI_spawn_units;	
    ["Skalisty32",2,2,false] call DZAI_spawn_units;	
    ["Skalisty33",3,3,false] call DZAI_spawn_units;
    ["Skalisty34",2,2,false] call DZAI_spawn_units;	
    ["Skalisty35",2,3,false] call DZAI_spawn_units;	
    ["Skalisty36",2,2,false] call DZAI_spawn_units;	
    ["Skalisty37",2,3,false] call DZAI_spawn_units;	
    ["Skalisty38",2,2,false] call DZAI_spawn_units;	
    ["Skalisty39",2,3,false] call DZAI_spawn_units;	
    ["Skalisty40",2,2,false] call DZAI_spawn_units;	
    ["Skalisty41",2,3,false] call DZAI_spawn_units;	
    ["Skalisty42",2,2,false] call DZAI_spawn_units;	
    ["Skalisty43",2,3,false] call DZAI_spawn_units;	
    ["Skalisty44",4,3,false] call DZAI_spawn_units;
    ["Skalisty45",5,3,false] call DZAI_spawn_units;	
    ["Skalisty46",3,2,false] call DZAI_spawn_units;	
    ["Skalisty47",3,3,false] call DZAI_spawn_units;	
    ["Skalisty48",4,3,false] call DZAI_spawn_units;
